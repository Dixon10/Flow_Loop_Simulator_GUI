  ...
  switch(mode)
  {
    ...
    case 2:
      ...
      { 
        ...
        if((acidValueTemp>3)&&(acidValueTemp<5)) //typical ph value of acid standard buffer solution should be 4.00
        {
    ...
    case 3:
      if(enterCalibrationFlag)
      {
        ...
        if((alkaliValueTemp>8)&&(alkaliValueTemp<11)) //typical ph value of alkali standard buffer solution should be 9.18 or 10.00
        {
